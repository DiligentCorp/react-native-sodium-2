...
Optionally, you can choose to compile libsodium by yourself (run **run rebuild** in package directory). Source code will be downloaded and verified before compilation.
